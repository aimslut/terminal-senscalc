...
// Use a namespace to avoid potential naming conflicts
namespace sens_converter {
...
void menu( const std::string &input ) {
    if ( input == "cm" )        sens_converter::cm();
    if ( input == "convert" )   sens_converter::convert();
    if ( input == "sens" )      sens_converter::sens();
    if ( input == "games" )     sens_converter::games();
    if ( input == "help" )      sens_converter::help();
}
